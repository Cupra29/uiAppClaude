...
test("MessageList renders with empty message array", () => {
  // MessageList no longer shows empty state - that's handled by ChatInterface
  // This test just verifies it doesn't crash with empty messages
...
test("MessageList renders messages with parts", () => {
  ...
  // Now it shows a friendly message instead of the raw tool name
